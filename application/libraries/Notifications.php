...
class Notifications
{
    ...
    public function notify_appointment_saved(
        ...
        try {
            ...
            $customer_link = 'https://osteoremouche.fr/index.php/booking/reschedule/' . $appointment['hash'];
            $provider_link = 'https://osteoremouche.fr/index.php/calendar/reschedule/' . $appointment['hash'];
            $customer_link_sms = 'https%3A//osteoremouche.fr/index.php/booking/reschedule/' . $appointment['hash'];
            $provider_link_sms = 'https%3A//osteoremouche.fr/index.php/calendar/reschedule/' . $appointment['hash'];
